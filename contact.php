            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <form method="POST">
                        <div class="row g-3">
                            <div class="col-12">
                                <input name="name" required type="text" class="form-control bg-light border-0 px-4" placeholder="Your Name" style="height: 55px;">
                            </div>
                            <div class="col-12">
                                <input name="email" required type="email" class="form-control bg-light border-0 px-4" placeholder="Your Email" style="height: 55px;">
                            </div>
                            <div class="col-12">
                                <input name="subject" required type="text" class="form-control bg-light border-0 px-4" placeholder="Subject" style="height: 55px;">
                            </div>
                            <div class="col-12">
                                <textarea name="message" required class="form-control bg-light border-0 px-4 py-3" rows="8" placeholder="Message"></textarea>
                            </div>
                            <div class="col-12">
                    ...
                    <div class="bg-light mb-5 p-5">
                        ...
                        <div>
                            <iframe class="position-relative w-100"
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d482051.7171232475!2d72.36876627343752!3d19.2811033!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b78f67e69155%3A0x73c0065eb0fa202e!2sAnimal%20Rescue%20%26%20Shelter%20Foundation!5e0!3m2!1sen!2sin!4v1707052456506!5m2!1sen!2sin" 
...
if(isset($_POST['send'])){
    ...
    $insert_query="INSERT INTO `user_queries` (name, email, subject, message) VALUES ('{$name}','{$email}','{$subject}','{$message}' )";
