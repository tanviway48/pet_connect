...
<body>
        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    <h1 class="display-1 text-uppercase text-dark mb-lg-4">Pet Connect</h1>
                    <h1 class="text-uppercase text-white mb-lg-4">Home for every soul</h1>
                    ...
                    <div class="d-flex align-items-center justify-content-center justify-content-lg-start pt-5">
                        ...
                        <button type="button" class="btn-play" data-bs-toggle="modal"
                            data-src="https://www.youtube.com/embed/YWGzaqigAo8?si=thsTQ5xCT_W07cIe" data-bs-target="#videoModal">
                            <span></span>
                        </button>
            ...
            <div class="row gx-5">
                <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded" src="https://encrypted-tbn3.gstatic.com/licensed-image?q=tbn:ANd9GcTlGLFC3Vw-H9IHZGHwRC8jT5LfOvmPOx82Ulam9zC8OoPoap9Zm13iuLn43CgGNl1JNeqV3aYLaoYg21c" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="border-start border-5 border-primary ps-5 mb-5">
                        <h6 class="text-primary text-uppercase">About Us</h6>
                        <h1 class="display-5 text-uppercase mb-0">Precious people adopt and precious animals are adopted</h1>
                    </div>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px;">
                <h6 class="text-primary text-uppercase">Proud Pawrents</h6>
                <h1 class="display-5 text-uppercase mb-0">The one who adopted friends from us</h1>
            </div>
            <div class="owl-carousel team-carousel position-relative" style="padding-right: 25px;">
                <div class="team-item">
                    ...
                    <div class="bg-light text-center p-4">
                        <h5 class="text-uppercase">Darsana Nair</h5>
                        <p class="m-0"></p>
                    </div>
                </div>
                <div class="team-item">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="img/parth.jpg" alt="">
                        <div class="team-overlay">
                            <div class="d-flex align-items-center justify-content-start">
                                <a class="btn btn-light btn-square mx-1" href="#"><i class="bi bi-twitter"></i></a>
                                <a class="btn btn-light btn-square mx-1" href="#"><i class="bi bi-facebook"></i></a>
                    ...
                    <div class="bg-light text-center p-4">
                        <h5 class="text-uppercase">Parth Phadke</h5>
                        <p class="m-0"></p>
                    </div>
                </div>
                <div class="team-item">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="img/rushi.jpg" alt="">
                        <div class="team-overlay">
                            <div class="d-flex align-items-center justify-content-start">
                                <a class="btn btn-light btn-square mx-1" href="#"><i class="bi bi-twitter"></i></a>
                                <a class="btn btn-light btn-square mx-1" href="#"><i class="bi bi-facebook"></i></a>
                    ...
                    <div class="bg-light text-center p-4">
                        <h5 class="text-uppercase">Rushikesh Zade</h5>
                        <p class="m-0"></p>
                    </div>
                </div>
                <div class="team-item">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="img/kailash.jpeg" alt="">
                        <div class="team-overlay">
                            <div class="d-flex align-items-center justify-content-start">
                                <a class="btn btn-light btn-square mx-1" href="#"><i class="bi bi-twitter"></i></a>
                                <a class="btn btn-light btn-square mx-1" href="#"><i class="bi bi-facebook"></i></a>
                    ...
                    <div class="bg-light text-center p-4">
                        <h5 class="text-uppercase">Kailash Nair</h5>
                        <p class="m-0"></p>
                    </div>
                </div>
                <div class="team-item">
                    ...
                    <div class="bg-light text-center p-4">
                        <h5 class="text-uppercase">Tanvi Waykar</h5>
                        <p class="m-0"></p>
                    </div>
                </div>
                <div class="team-item">
                    ...
                    <div class="bg-light text-center p-4">
                        <h5 class="text-uppercase">Aditi Nandvikar</h5>
                        <p class="m-0"></p>
                    </div>
                </div>
            </div>
