...
<body>
    ...
    <div class="container">
        ...
        //             <strong>Congratulations!</strong> You logged in successfully....
        ...
        // }
        ?>
      <form action="signin.php" class=" align-items-center border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px;" method="post">
        <div class="form-group">
            <input type="email" placeholder="Enter Email:" name="email" class="form-control bg-light border-5 px-4 mt-5 5 5 5">
        </div>
        <div class="form-group">
            <input type="password" placeholder="Enter Password:" name="password" class="form-control  bg-light border-5 px-4 mt-5 5 5 5">
        </div>
        <div class="form-btn">
            <input type="submit" value="Login" name="login" class="btn btn-primary w-100 py-3 mt-5">
        </div>
      </form>
